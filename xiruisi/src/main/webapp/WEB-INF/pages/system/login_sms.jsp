...
<div class="login-box">
    ...
    <div class="py-container copyright">
        <ul>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">关于我们</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">联系我们</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">联系客服</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">商家入驻</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">营销中心</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">手机喜瑞斯</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">销售联盟</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">喜瑞斯社区</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">喜瑞斯公益</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">English Site</a></li>
            <li><a href="${pageContext.request.contextPath}/system/toDeveloping" target="_blank">Contact U</a></li>
        </ul>
